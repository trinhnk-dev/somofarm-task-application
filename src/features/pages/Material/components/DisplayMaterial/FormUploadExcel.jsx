...
const FormUploadExcel = ({
  ...
  const onFinish = (values) => {
    ...
    onFinishCreateMaterialExcel({ ...values, excelFile: fileValue })
    closeModalExcel()
    form.resetFields()
  }
  ...
  return (
    <>
      <Modal
        title="Thêm công cụ bằng tệp excel"
        open={isModalOpenExcel}
        onCancel={closeModalExcel}
        footer={[
          <Button
            form="uploadExcelMaterial"
            type="primary"
            danger
          ...
          <Button form="uploadExcelMaterial" type="primary" htmlType="submit">
            Hoàn thành
          </Button>,
        ]}
      >
